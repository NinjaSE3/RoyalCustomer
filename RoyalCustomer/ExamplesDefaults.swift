...
struct ExamplesDefaults {
    ...
    private static var iPadChartSettings: ChartSettings {
        ...
        chartSettings.axisStrokeWidth = 1.5
    ...
    static func chartFrame(containerBounds: CGRect) -> CGRect {
        return CGRectMake(0, 350, 350, 250)
    }
    ...
    static var labelFont: UIFont {
        return ExamplesDefaults.fontWithSize(Env.iPad ? 16 : 14)
    }
    
    static var labelFontSmall: UIFont {
        return ExamplesDefaults.fontWithSize(Env.iPad ? 15 : 13)
    }
