...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    */
    ...
    func createItems() {
        ...
        items.append(Item(itemid:"000001",name:"森永の焼プリン",image:"Item1",award1:[],award2:[15], prchedHist:["2015/8":5,"2015/7":10, "2015/6":9,"2015/5":8,"2015/4":12,"2015/3":7], prchedThisM:[1:1,3:2,4:1,5:1], brandImage: "Brand2_icon", outline:"カラメルソースのほろ苦さがクリーミープリンにぴったりです。\n遠赤外線オーブンで焼き上げたシンプルな味わいを、\nゆったりとリラックスしてお楽しみ下さい。"))
