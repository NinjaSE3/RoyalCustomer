...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    */
    ...
    func createItems() {
        ...
        items.append(Item(itemid:"000002",name:"ムービングラバーワイルドシェイク",image:"Item2",award1:[],award2:[], prchedHist:["2015/8":3,"2015/7":20, "2015/6":10,"2015/5":12,"2015/4":5,"2015/3":8,"2015/2":15], prchedThisM:[1:1,4:1,6:1,7:2,8:1,9:1,10:1,11:1,12:1,13:1,14:1,20:1], brandImage: "Brand3_icon", outline:"ムービングラバー配合のスタイリングワックスです。立体感あふれるワイルドな動きが楽しめます。"))
